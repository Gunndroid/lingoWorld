    ...
    <div className="flex flex-col justify-center my-10 border border-black bg-m-white md:w-1/2 rounded-lg p-4 md:mx-auto mx-4">
      ...
      <div className="flex items-center justify-center mt-4">
        <a
          type="button"
          href="tel:+1234567890"
          className="mx-auto text-center w-3/4 rounded border border-m-black bg-m-red px-12 py-3 text-lg font-medium text-white hover:bg-white hover:text-m-red focus:outline-none"
        >
