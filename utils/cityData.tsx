...
export const cityData = [
  ...
  // Rio de Janeiro
  {
    ...
    members: [
      {
        name: "Lucas Green",
        bio: "Passionate about Brazilian culture and languages. Fluent in Portuguese and learning Spanish.",
        imgUrl: "https://source.unsplash.com/100x100/?portrait?11",
      },
      {
        name: "Mia White",
        bio: "Loves exploring Brazilian cuisines. Speaks fluent English and is learning Portuguese.",
        imgUrl: "https://source.unsplash.com/100x100/?portrait?12",
      },
      {
        name: "Noah Black",
        bio: "Travel enthusiast with a passion for Brazilian music. Fluent in French and picking up Portuguese.",
